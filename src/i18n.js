...
const ui = {
  en: {
    ...
    welcomeH1: 'A free blog you can actually publish to in minutes.',
    welcomeIntro:
      'kantan (かんたん) means simple. Sign in with just your email, and kantan wires up your GitHub repo, hosting, and editor for you.',
    welcomeHow: 'How it works',
    welcomeStep1: 'Sign in with your email — no passwords, no GitHub login for the panel.',
    welcomeStep2: 'Connect GitHub + Cloudflare — one paste of a Cloudflare token; kantan creates everything.',
    welcomeStep3: 'Write & publish — edit posts in a friendly editor; every save rebuilds your site.',
    ...
    deleteConfirmBody:
      'This permanently deletes the GitHub repo, the Cloudflare Pages project, and this registration. There is no undo.',
  ...
  ja: {
    ...
    step2Body:
      'Cloudflare Pages: Edit と Account Settings: Read の権限を持つ API トークンを貼り付けてください（作成 →「Create Custom Token」→ 両方の権限を追加）。Account Settings: Read でアカウントを自動検出します。トークンはサイト作成の1回だけ使用され、保存されません。',
    ...
    tokenWorksAccount: '✓ トークンは動作しています — アカウント:',
    accountsFound: '件のアカウントが見つかりました。使用するものを選択してください:',
    tokenCantList:
      '✓ トークンは認証されますが、アカウントを一覧取得できません。所属する Cloudflare アカウント ID を入力するか、トークンに「Account Settings: Read」を追加してください。',
    ...
    tooShortBranded: 'ブランドアドレスには短すぎるため、pages.dev のみを使用します。',
    createSite: 'ウェブサイトを作成',

    provisioningFailed: 'プロビジョニングに失敗しました: ',
    couldNotReach: 'サーバーに接続できませんでした',
    partialCreate: '。サイトが部分的に作成された可能性があります。GitHub を確認して再試行してください。',
    yourSiteBuilding: 'サイトを構築中です。',
    repo: 'リポジトリ:',
    site: 'サイト:',
    editor: 'エディター:',
    ...
    updating: '更新中…',
    applyingUpdate: '更新を適用してサイトを再構築しています。1〜2分かかります。',
    updateComplete: '更新が完了しました',
    updateCompleteBody:
      'サイトをテンプレート {to} に更新しました（{n} ファイル変更）。デプロイが開始され、1〜2分で公開されます。',
    viewBuild: 'ビルドを表示',
    done: '完了',
    updateFailed: '更新に失敗しました',
    updateTo: '{to} に更新',
    filesNeverTouched: '投稿・画像・設定には触れません。変更されるファイル:',
    noCoreChanges: 'コアファイルの変更はありません',
    moreFiles: '…他 {n} 件',
    majorBump:
      'メジャーバージョンアップ: {deps}。外観が変わったりカスタマイズが壊れる可能性があります — 更新前に確認してください。',
    ...
    reasonCi: 'テンプレートが現在 CI を通していません — 通るまで更新は保留されます。',
    reasonLegacy: 'このサイトはバージョン管理導入前に作成されました。まだアップグレードは提供されていません。',
    ...
    deleteConfirmBody:
      'GitHub リポジトリ、Cloudflare Pages プロジェクト、登録情報が完全に削除されます。元に戻せません。',
    deleteCfToken: 'Cloudflare API トークン（Pages プロジェクト削除用）',
    ...
    deleteRemaining: '一部を削除できませんでした:',
    setBaseline: 'ベースラインを設定',
    baselineSetting: '設定中…',
    baselineComplete: 'ベースラインを設定しました — 更新を確認できます。',
    baselineFailed: 'ベースラインを設定できませんでした。',

    exportContent: 'コンテンツを書き出す',
    exporting: '書き出し中…',
    exportFailed: '書き出しに失敗しました',
    bringContent: 'コンテンツを引き継ぐ（任意）',
    bringContentHint: '既存の投稿・画像・設定から始められます。',
    contentFromSite: '既存サイトから読み込む',
    contentNone: 'なし',
    contentUploadBundle: 'コンテンツバンドル (.zip) をアップロード',
    startFreshBringContent: '新しく作り直してコンテンツを引き継ぐ',
  ...
  'zh-Hant': {
    ...
    welcomeStep2: '連接 GitHub + Cloudflare — 貼上一次 Cloudflare 權杖，kantan 會建立一切。',
    welcomeStep3: '撰寫並發布 — 在友善的編輯器中編輯文章；每次儲存都會重建網站。',
    welcomeKeys: '金鑰由你保管',
    welcomeKeysBody:
      'kantan 絕不儲存你的 GitHub 或 Cloudflare 憑證。它們只會用於建立網站的短短幾秒，寫入你自己的儲存庫作為部署密鑰，然後隨即捨棄。你隨時可以撤銷或輪換。',
    ...
    contentNone: '無',
    contentUploadBundle: '上傳內容套件 (.zip)',
  ...
  'zh-Hans': {
    ...
    welcomeTitle: 'kantan — 几分钟内发布博客',
    welcomeOpen: '打开仪表板',
    welcomeGetStarted: '开始使用',
    welcomeH1: '免费的博客，真的能在几分钟内发布。',
    welcomeIntro:
      'kantan（かんたん）就是「简单」。只用电子邮件登录，kantan 就会自动为你准备好 GitHub 仓库、托管与编辑器。',
    welcomeHow: '运作方式',
    welcomeStep1: '用电子邮件登录 — 不需要密码，也不用登录 GitHub。',
    welcomeStep2: '连接 GitHub + Cloudflare — 粘贴一次 Cloudflare 令牌，kantan 会创建一切。',
    welcomeStep3: '撰写并发布 — 在友好的编辑器中编辑文章；每次保存都会重建网站。',
    welcomeKeys: '密钥由你保管',
    welcomeKeysBody:
      'kantan 绝不存储你的 GitHub 或 Cloudflare 凭据。它们只会在创建网站的短短几秒内使用，写入你自己的仓库作为部署密钥，然后随即丢弃。你随时可以撤销或轮换。',
